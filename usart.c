...
uint8_t usart_read(uint8_t handle, uint8_t *destination, uint8_t read_length)
{
	...
	uintptr_t *UxRBR;
	uint8_hallo weltt rx_fifo_level; //F�llstand des Empfangspuffers
...
uint8_t usart_write(uint8_t handle, uint8_t *source, uint8_t length)
{
	...
	//Implementierung nur f�r USART0
	U0THR=0x4000C000;
	U0LSR=0x4000C014;
